...
def u_net_bn(x, is_train=False, reuse=False, is_refine=False):
    ...
    with tf.compat.v1.variable_scope("u_net", reuse=reuse):
        ...
        up6 = DeConv2d(up6, 1024, (4, 4), out_size=(3, 3), strides=(2, 2), padding='SAME',
        ...
        up5 = DeConv2d(up5, 1024, (4, 4), out_size=(6, 6), strides=(2, 2), padding='SAME',
        ...
        up4 = DeConv2d(up4, 1024, (4, 4), out_size=(11, 11), strides=(2, 2), padding='SAME',
        ...
        up3 = DeConv2d(up3, 256, (4, 4), out_size=(22   , 22), strides=(2, 2), padding='SAME',
        ...
        up2 = DeConv2d(up2, 128, (4, 4), out_size=(44, 44), strides=(2, 2), padding='SAME',
        ...
        up1 = DeConv2d(up1, 64, (4, 4), out_size=(88, 88), strides=(2, 2), padding='SAME',
        ...
        up0 = DeConv2d(up0, 64, (4, 4), out_size=(176, 176), strides=(2, 2), padding='SAME',
