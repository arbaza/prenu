...
def main_train():
    ...
    # define placeholders
    t_image_good = tf.compat.v1.placeholder('float32', [batch_size, nw, nh, nz], name='good_image')
    t_image_good_samples = tf.compat.v1.placeholder('float32', [sample_size, nw, nh, nz], name='good_image_samples')
    t_image_bad = tf.compat.v1.placeholder('float32', [batch_size, nw, nh, nz], name='bad_image')
    t_image_bad_samples = tf.compat.v1.placeholder('float32', [sample_size, nw, nh, nz], name='bad_image_samples')
    t_gen = tf.compat.v1.placeholder('float32', [batch_size, nw, nh, nz], name='generated_image_for_test')
    t_gen_sample = tf.compat.v1.placeholder('float32', [sample_size, nw, nh, nz], name='generated_sample_image_for_test')
    t_image_good_244 = tf.compat.v1.placeholder('float32', [batch_size, 244, 244, 3], name='vgg_good_image')
    ...
    imageio.imwrite(os.path.join(save_dir, "mask.png"), mask * 255)
